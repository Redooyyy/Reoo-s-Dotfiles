[Redooyyy](https://www.github.com/Redooyyy)
...
| :----------- | :------------------------------------------------------------------------------------------------------------------------------------------------ | :----------------- |
| **`nvim`**   | Highly customized Neovim configuration focused on speed, LSP integration (Language Server Protocol), and key mappings for efficient code editing. | `./config/nvim/`   |
